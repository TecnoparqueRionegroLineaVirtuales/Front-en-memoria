    ...
    <div class="h-full">
      ...
      <div class="w-full container mx-auto">
        ...
        <nav class="flex items-center">
            <a href="#" class="text-indigo-400 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">
                INICIO
            </a>
            <a href="#" class="text-indigo-400 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out">
                MURALES
